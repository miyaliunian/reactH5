...
const actionTypes = {
  ...
  FETCH_DAILYLIST_QUERY_SUCCESS:
    "DAILYLIST_QUERY/FETCH_DAILYLIST_QUERY_SUCCESS",
  ...
  switch (action.type) {
    ...
    case actionTypes.FETCH_DAILYLIST_QUERY_SUCCESS:
      return {
        ...
        isFetching: false,
        listInFeeDetail:
          action.response.data.listInFeeDetail === null
            ? []
            : action.response.data.listInFeeDetail,
