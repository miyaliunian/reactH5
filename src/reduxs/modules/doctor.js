...
const actionTypes = {
  ...
  FETCH_DOCTOR_SCHEDULE_TIME_SUCCESS:
    "DOCTOR/FETCH_DOCTOR_SCHEDULE_TIME_SUCCESS",
  FETCH_DOCTOR_SCHEDULE_TIME_FAILURE:
    "DOCTOR/FETCH_DOCTOR_SCHEDULE_TIME_FAILURE",
