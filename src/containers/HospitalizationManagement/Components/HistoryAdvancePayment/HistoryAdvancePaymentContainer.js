...
class HistoryAdvancePaymentContainer extends Component {
  render() {
    ...
    return (
      <div className={"historyAdvancePayment"}>
        ...
        >
          <div
            className={"historyAdvancePayment_container"}
            ref={"historyAdvancePaymentWrapper"}
          >
            <div>
              {data.map(item => {
                return (
                  <div key={item.billNo}>
                    <div
                      className={
                        "historyAdvancePayment_container_header border-bottom"
                      }
                    >
                      <span
                        style={{
                    ...
                    <div className={"historyAdvancePayment_container_body"}>
                      <div
                        className={"historyAdvancePayment_container_body_row"}
                      >
                        <span
                          style={{
  ...
  componentDidMount() {
    ...
    this.props.historyAdvancePaymentActions.loadData(
      "inPrePay",
      hosId,
      inHosNo
    );
...
const mapDispatchToProps = dispatch => {
  return {
    historyAdvancePaymentActions: bindActionCreators(
      historyAdvancePaymentActions,
      dispatch
    )
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(HistoryAdvancePaymentContainer);
