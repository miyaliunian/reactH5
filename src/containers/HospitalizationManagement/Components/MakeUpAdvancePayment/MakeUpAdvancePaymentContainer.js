      ...
      <div className={"makeUpAdvancePayment"}>
        ...
        >
          ...
          <div style={{ padding: "10px", backgroundColor: "white" }}>
            <p>选择缴费金额</p>
            <div
              className={"makeUpAdvancePayment_price_container"}
              style={{
                display: "flex",
                flex: 1,
                flexDirection: "row",
            ...
            >
              {amounts.map((item, index) => {
                return (
                  <div
                    key={index}
                    className={"makeUpAdvancePayment_price_item border-theme"}
                    onClick={() => this.setState({ amountSel: item })}
                  >
                    <span className={"makeUpAdvancePayment_price_item_txt"}>
                      {item}元
                    </span>
                  </div>
                );
          ...
          >
            ...
            <input
              placeholder={"￥"}
              className={"makeUpAdvancePayment_price_input"}
