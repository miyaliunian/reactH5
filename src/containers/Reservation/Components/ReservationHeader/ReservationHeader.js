...
export default class ReservationHeader extends Component {
        ...
        <div className={"reservationHeader__info border-bottom"}>
          <div className={"reservationHeader__cell"}>
            ...
            <div className={"reservationHeader__right_colu"}>
              <span className={"reservationHeader__right_colu__txt"}>
                {hosName}
              </span>
            </div>
          </div>
          ...
          <div className={"reservationHeader__cell"}>
            ...
            <div className={"reservationHeader__right_colu"}>
              <span
                className={"reservationHeader__right_colu__txt right__price"}
              >
                ￥{regFee.toFixed(2)}
              </span>
            </div>
  ...
  drawReact(data) {
    ...
    return <span className={"reservationHeader__avatar"}>{str}</span>;
  }
}
