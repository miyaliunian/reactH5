...
import { actions as reportDetailActions, getFetchingStatus, getReportDetailData } from '@reduxs/modules/reportDetail'
...
class ReportDetail extends Component {
  ...
  render() {
    const { isFetching, checkresult } = this.props
    return (
      <div className={'reportDetail'}>
        <SafeAreaView showBar={true} title={'检验报告单'} isRight={false} handleBack={this.handleBack}>
          <li
            // key={Detail.id}
            ...
            <div className={'reportDetail__Detail__info'}>
              ...
              <div className={'Detail__info__row'}></div>
            </div>
            <div className={'reportDetail__Detail__info'}>
              <div className={'Detail__info__row'}>
            ...
            <div className={'reportDetail__Detail__info'}>
              ...
              <div className={'Detail__info__row2'}></div>
            </div>
            <div className={'reportDetail__Detail__info'}>
              <div className={'Detail__info__row2'}></div>
              <div className={'Detail__info__row2'}>
