...
import {
    actions as registerDetailActions,
    getDetail
} from '@reduxs/modules/registerDetail'
            ...
            <SafeAreaView showBar={true} title={'预约详情'} isRight={false} handleBack={this.handleBack}>
                ...
                <div className={'registerDetail-part3 border-top'}>
                    <div className={'registerDetail-part3-item border-bottom'}>
                        ...
                        <div className={'registerDetail-part3-item-value'}>耿昌健</div>
                    </div>
                    <div className={'registerDetail-part3-item border-bottom'}>
                        <div className={'registerDetail-part3-item-key'}>初/复诊</div>
                        <div className={'registerDetail-part3-item-value'}>初诊</div>
                    </div>
                    <div className={'registerDetail-part3-item border-bottom'}>
                        <div className={'registerDetail-part3-item-key'}>医疗类别</div>
                        <div className={'registerDetail-part3-item-value'}>普通门诊</div>
                    </div>
                    <div className={'registerDetail-part3-item border-bottom'}>
                        <div className={'registerDetail-part3-item-key'}>疾病信息</div>
                        <div className={'registerDetail-part3-item-value'}>尚未确诊</div>
                    </div>
                </div>
                ...
                <div className={'registerDetail-part5'}>
                    <div className={'registerDetail-part5-btn'}>支付</div>
                    <div className={'registerDetail-part5-btn'}>取消预约</div>
                </div>
                <div className={'registerDetail-part6'}>
                    <div className={'registerDetail-part6-fee'}>
                        ...
                        <div className={'registerDetail-part6-fee-cost'}>{'￥' + detail.totCost}</div>
                    </div>
                </div>
                <LoadingMask/>
            </SafeAreaView>
