    ...
    return (
      <div className={"tabs border-bottom"}>
        <ul className={"tabs__searchTOPWrapper"}>
          ...
          <li
            className={
              this.state.tab2focused ? "searchItem2Seled" : "searchItem2"
            }
            onClick={() => this.tabSelc(2)}
          >
            {this.state.tab2focused_title}
            <div
              className={this.state.tab2focused ? "searchItemSeledLine" : ""}
            />
          </li>
          <li
            className={
              this.state.tab3focused ? "searchItem  itemSelected" : "searchItem"
            }
        ...
        <div
          ...
          className={
            this.state.tabMaskIsSHow
              ? "tabs__BottomWrapper__con__show border-top"
              : "tabs__BottomWrapper__con"
          }
          onClick={() => this.close()}
          ...
          {this.state.tab1focused ? (
            ...
            >
              {areasList.map(item => {
                return (
                  <div
                    className={"tabs__Bottom__Item border-bottom"}
                    key={item.name}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div
                    className={"tabs__tab3__btn"}
                    onClick={() => this.tabItemBtnClick()}
                  >
                    确定
                  </div>
                </div>
