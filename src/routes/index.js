...
const HospitalsComponent = lazy(() =>
  import("@containers/Hospitals/HospitalsContainer")
);
const LoginComponent = lazy(() => import("@containers/Login/LoginContainer"));
const DivisionComponent = lazy(() =>
  import("@containers/Division/DivisionContainer")
);
const BindCardComponent = lazy(() =>
  import("@components/BindCard/BindCardContainer")
);
const BindCardListComponent = lazy(() =>
  import("@components/BindCard/components/BindCardList/BindCardList")
);
const DoctorListComponent = lazy(() =>
  import("@containers/DoctorList/DoctorListContainer")
);
const DoctorComponent = lazy(() =>
  import("@containers/Doctor/DoctorContainer")
);
//(再次预约)从订单查询-进入 医生详情
const OrderReservationDoctorComponent = lazy(() =>
  import("@containers/Order/orderReservationDoctorContainer")
);
const ReservationContainerComponent = lazy(() =>
  import("@containers/Reservation/ReservationContainer")
);
const IntelligentWaitingContainerComponent = lazy(() =>
  import("@containers/IntelligentWaiting/IntelligentWaitingContainer")
);
const RegisterContainerComponent = lazy(() =>
  import("@containers/Register/RegisterContainer")
);
const HospitalizationManagementContainerComponent = lazy(() =>
  import(
    "@containers/HospitalizationManagement/HospitalizationManagementContainer"
  )
);
const ReportContainerComponent = lazy(() =>
  import("@containers/Report/ReportContainer")
);
const MakeUpAdvancePaymentComponent = lazy(() =>
  import(
    "@containers/HospitalizationManagement/Components/MakeUpAdvancePayment/MakeUpAdvancePaymentContainer"
  )
);
const HistoryAdvancePaymentComponent = lazy(() =>
  import(
    "@containers/HospitalizationManagement/Components/HistoryAdvancePayment/HistoryAdvancePaymentContainer"
  )
);
const DailyListQueryPaymentComponent = lazy(() =>
  import(
    "@containers/HospitalizationManagement/Components/DailyListQueryPayment/DailyListQueryPaymentContainer"
  )
);
...
//从订单查询-进入 预结算
const OrderMedicarePayContainerComponent = lazy(() =>
  import("@containers/Order/orderMedicarePayContainer")
);
//从订单进入-纯自费支付
const OrderThirdPayContainerComponent = lazy(() =>
  import("@containers/Order/orderThirdPayContainer")
);
//医保支付
const MedicarePayComponent = lazy(() =>
  import("@components/Pay/MedicarePay/MedicarePayContainer")
);
//第三方支付
const ThirdPayContainerComponent = lazy(() =>
  import("@components/Pay/ThirdPay/ThirdPayContainer")
);
//支付成功倒计时
const PayCountdownComponent = lazy(() =>
  import("@components/Pay/Countdown/PayCountdown")
);
//支付成功
const PayResultContainerComponent = lazy(() =>
  import("@components/Pay/Result/PayResultContainer")
);
